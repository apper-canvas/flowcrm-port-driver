...
const ContactDetailModal = ({ isOpen, onClose, contactId, onEdit }) => {
  ...
  const loadContactDetails = async () => {
    ...
    try {
      const [contactData, dealsData, tasksData, activitiesData] = await Promise.all([
        ...
        taskService.getByContactId(contactId),
                  ...
                  <div className="space-y-4">
                    {tasks.length === 0 ? (
                      <Empty
                        ...
                        description="This contact doesn't have any tasks yet."
                        icon="CheckSquare"
                      />
                    ) : (
                      tasks.map((task) => (
                  ...
                  <div className="space-y-4">
                    {activities.length === 0 ? (
                      <Empty
                        ...
                        description="No activities have been recorded for this contact yet."
                        icon="Activity"
                      />
                    ) : (
